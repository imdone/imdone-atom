module.exports =  (repo) ->
  ...
  # TODO:130 Handle the case when imdone.io is offline!  Keep a message saying offline! and auto reconnect when it's back.
  ...
  repo.checkForIIOProject = checkForIIOProject = () ->
    ...
    client.getProject repo.getProjectId(), (err, project) =>
      # TODO:60 Do something with this error
      return if err
      unless project
  ...
  syncFile = (file, cb) ->
    ...
    client.syncTasks repo, file.getTasks(), (err, tasks) ->
      return if err # TODO:80 Do something with this error
  ...
  saveSortCloud = (cb) ->
    ...
    # DOING:40 This should call client.updateTaskOrder, but we should also listen for pusher messages on project update
