  ...
  @content: (params) ->
    @div class: "imdone-menu", =>
      @div class: "imdone-menu-inner", =>
        # READY: Show logged in user and avatar here id:620
        ...
        # BACKLOG: Save my favorite filters +story id:621
        @div class: "imdone-toolbar", =>
          @div class: "imdone-profile imdone-toolbar-button", outlet: "$profile", =>
            @div outlet:'$login', class:'text-success imdone-icon', title:'Blast off! login and share', =>
              # DONE: Replace this with imdone-logo-dark.svg [Icon System with SVG Sprites | CSS-Tricks](https://css-tricks.com/svg-sprites-use-better-icon-fonts/) id:622
          ...
          # BACKLOG: Open package config with a button click `atom.workspace.open 'atom://config/packages/imdone-atom'` <https://github.com/mrodalgaard/atom-todo-show/blob/804cced598daceb1c5f870ae87a241bbf31e2f17/lib/todo-options-view.coffee#L49> id:623
          ...
          # DONE: Add a link to open filtered files issue:49 id:624
          ...
          # BACKLOG: Add the plugin project buttons id:1962
