...
class ProductDetailView extends View
  ...
  # READY:60 Add enable checkbox and take appropriate actions on check/uncheck +urgent
  # READY:30 When unlinked disable all connectors (In API) +urgent
  getDetail: (product) ->
    $$ ->
      @h1 "#{product.name}"
