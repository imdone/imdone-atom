...
class ProductDetailView extends View
  ...
  # READY:40 Add enable checkbox and take appropriate actions on check/uncheck +urgent id:100
  # READY:310 When unlinked disable all connectors (In API) +urgent id:101
  getDetail: (product) ->
    $$ ->
      @h1 "#{product.name}"
