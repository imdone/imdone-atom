...
class BottomView extends View
    ...
    @div class:'imdone-bottom-view', =>
      @div class:'bottom-view-header', =>
        ...
        @div outlet: 'closeButton', class:'close-button', =>
          @raw '&times;'
        # DONE: Set up a global messaging area. +enhancement gh:159 id:57
  ...
  handleEvents: (@emitter)->
    ...
    # #DONE: Make resizable when open [Edit fiddle - JSFiddle](http://jsfiddle.net/3jMQD/614/) id:58
    ...
    # DONE: This belongs in bottomView +refactor gh:144 id:59
    @emitter.on 'list.new', => @showNewList()

    # DONE: This belongs in bottomView +refactor gh:143 id:60
