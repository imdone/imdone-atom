...
module.exports = ImdoneAtom =
  ...
  activate: (state) ->
    # READY:140 Put requires in activate to speed up startup issue:77 id:570
    # #DONE:190 Add back serialization (The right way) +Roadmap @testing id:571
    _ = require 'lodash'
    url = require 'url'
    ...
    # DONE:210 Add file tree context menu to open imdone issues board. see [Creating Tree View Context-Menu Commands · Issue #428 · atom/tree-view](https://github.com/atom/tree-view/issues/428) due:2015-07-21 id:572
