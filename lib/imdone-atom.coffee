...
module.exports = ImdoneAtom =
  config:
    ...
    showNotifications:
      ...
      type: 'boolean'
      default: false
    # DONE: This is config for globs to open with editors issue:48 id:569
    openIn:
      title: 'File Opener'
  ...
  activate: (state) ->
    # READY: Put requires in activate to speed up startup issue:77 id:570
    # #DONE: Add back serialization (The right way) +Roadmap @testing id:571
    _ = require 'lodash'
    url = require 'url'
    ...
    # DONE: Add file tree context menu to open imdone issues board. see [Creating Tree View Context-Menu Commands · Issue #428 · atom/tree-view](https://github.com/atom/tree-view/issues/428) due:2015-07-21 id:572
  ...
  getCurrentProject: ->
    ...
    if active && active.getPath && active.getPath()
      # DONE: This fails for projects that start with the name of another project id:477
